...
unsigned char Reflector::reflect(unsigned char in, Rotor *rotor)
{
  ...
  unsigned char index = in - prev_char;
  unsigned char tmp = map[index];

  index = tmp + prev_char;
  unsigned char out = alphabet[index];
